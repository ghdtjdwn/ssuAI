...
ssuAI is the **Soongsil University AI web/app client**. The MCP server lives in a separate repo, **[hoeongj/ssuMCP](https://github.com/hoeongj/ssuMCP)**; ssuAI is the consuming frontend — card dashboard + natural-language chatbot + AI agent.
