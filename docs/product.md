...
- **No unified view of campus data.** Even simple things like "is this
...
5. **Read-only MCP server**
   ...
   - Usable from Claude Desktop and Cursor as a proof of concept
...
- Package structure under `com.ssuai`
