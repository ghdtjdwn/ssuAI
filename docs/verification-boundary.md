...
| Dependency advisory gate | 2026-09-02; Node 20, pnpm 10.34.5, Next.js 16.2.12, patched direct and transitive dependency ranges; npm registry advisory snapshot | `pnpm audit --audit-level moderate` reported no known vulnerabilities; lint, typecheck, 203 Vitest cases and production build passed; 13 Playwright checks passed and one conditional check skipped | Point-in-time package advisory and local build result; not a source review or runtime penetration test |
