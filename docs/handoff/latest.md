...
- prod 반영: `kubectl set image deployment/ssuai-backend backend=ghcr.io/ghdtjdwn/ssuai-backend:sha-1031de018ee12a06b009073af2b5a245630facb2`.
...
- `sudo kubectl set image deployment/ssuai-backend
  backend=ghcr.io/ghdtjdwn/ssuai-backend:sha-1031de018ee12a06b009073af2b5a245630facb2
