...
| Dependency advisory gate | 2026-07-28; Next.js 16.2.12 plus patched PostCSS, Sharp, Vite, Undici, js-yaml and brace-expansion transitive overrides; npm registry advisory snapshot | full `pnpm audit` reported no known vulnerabilities; lint, typecheck, 202 Vitest cases, production build and 14 Playwright checks passed | Point-in-time package advisory and local build result; not a source review or runtime penetration test |
