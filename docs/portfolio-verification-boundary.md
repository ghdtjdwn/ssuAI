...
| Dependency advisory gate | 2026-07-27; Next.js 16.2.12 plus patched PostCSS, Sharp, Vite, Undici and js-yaml transitive overrides; npm registry advisory snapshot | `pnpm audit --prod` reported no known vulnerabilities | Point-in-time package advisory result; not a source review or runtime penetration test |
