...
| [adr/](adr/) | 프론트엔드 및 챗봇 설계 결정 (0001·0006·0009·0010·0086) |

> ADR 번호는 ssuMCP와 **공유 시퀀스**입니다. 프론트엔드는 0001·0006·0009·0010·0086을 소유하고, 나머지 번호는 ssuMCP가 소유합니다 — 빠진 번호는 삭제가 아니라 다른 저장소 소유입니다. 신규 ADR 번호는 두 저장소에서 아직 예약·사용되지 않은 다음 번호를 사용합니다(0086 작성 시점 ssuMCP는 0085까지 예약).
