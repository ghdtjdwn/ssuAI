...
| [verification-boundary.md](verification-boundary.md) | 브라우저·에이전트·부하 증거의 조건, 운영 주장 한계, 배포 drift |
| [adr/](adr/) | 프론트엔드 및 챗봇 설계 결정 (0001·0006·0009·0010·0086·0087·0088·0089·0090·0099·0101) |

> ADR 번호는 ssuMCP와 **공유 시퀀스**입니다. 프론트엔드는 0001·0006·0009·0010·0086·0087·0088·0089·0090·0099·0101을 소유하고, 나머지 번호는 다른 서비스가 소유합니다 — 빠진 번호는 삭제가 아닙니다. 신규 ADR 번호는 전체 서비스에서 아직 예약·사용되지 않은 다음 번호를 사용합니다.
