...
| [adr/](adr/) | 프론트엔드 및 챗봇 설계 결정 (0001·0006·0009·0010) |

> ADR 번호는 ssuMCP와 **공유 시퀀스**입니다. 프론트엔드는 0001·0006·0009·0010을 소유하고, 나머지 번호(0002–0005·0007–0008 등)는 ssuMCP가 소유합니다 — 빠진 번호는 삭제가 아니라 다른 저장소 소유입니다.
