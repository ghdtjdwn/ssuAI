...
- ✅ 개인 도구 4개: `get_my_schedule`, `get_my_grades`, `get_my_assignments`, `get_my_library_loans`
...
# Transport: SSE, URL: http://localhost:8080/mcp → Connect → List Tools
```
